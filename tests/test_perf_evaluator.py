...
# ---------------------------------------------------------------------------
# PERF EVAL RESULT TESTS
# ---------------------------------------------------------------------------


class TestPerfEvalResult:
    """Test PerfEvalResult dataclass."""

    def test_perf_eval_result_creation(self):
        ...
        assert result.metrics.p50_latency_ms == 1500.0
...
class TestCasePerformance:
    """Test CasePerformance dataclass."""

    def test_successful_case_performance(self):
        """Should create successful case performance."""
        perf = CasePerformance(
            case_id="test-001",
            latency_ms=1500.0,
            input_tokens=500,
            output_tokens=200,
    ...
    def test_failed_case_performance(self):
        """Should create failed case performance with error."""
        perf = CasePerformance(
            case_id="test-001",
            latency_ms=0,
            input_tokens=0,
        ...
        assert perf.error == "Agent failed to respond"
...
class TestRegressionCheck:
    """Test RegressionCheck dataclass."""

    def test_regression_check_creation(self):
        """Should create regression check with all fields."""
        ...
        assert check.change_percent == 25.0
